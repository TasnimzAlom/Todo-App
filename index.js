...
document.querySelector(".form").addEventListener("submit", (e)=>{
    ...
    tasks[id] = new task(e.target.task.value);
    e.target.task.value = "";
...
function showTasks(tasks){
    ...
    var data = "";
    for(key in temp)
        data = data + task_format_1 + (tasks[key].completed?"completed":"") + task_format_2 + key + task_format_3 + tasks[key].text + task_format_4;
